...
class Fastfetch(loader.ModuleBase):
    name = "fastfetch"
    description: dict = {
        "ru": "вывoд инфopмaции o cиcтeмe чepeз fastfetch",
        "en": "display system information using fastfetch",
        "linux": "cmd: fastfetch on modules",
    }
    version = "1.0.1"
    author = "@Hairpin00"
    ...
    async def cmd_fastfetch(self, event: events.NewMessage.Event) -> None:
        try:
            ...
            await event.edit(
                f"<blockquote>Fastfetch:</blockquote>\n<blockquote><code>\n{output}</code></blockquote>",
                parse_mode="html",
            )
