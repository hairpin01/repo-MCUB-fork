...
class ModerationPlugin:
    ...
    tool_docs = {
        "moderation.mute": {
            "desc": "Mute a user in a chat",
            "args": "chat (str); user (str); until (int) — seconds (default 3600)",
            "body": "user identifier",
            "returns": "Text result or an error message.",
            "example": "{\"tool\": \"moderation.mute\", \"args\": {\"chat\": \"@chat\", \"user\": \"@user\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "moderation.unmute": {
            "desc": "Unmute a user in a chat",
            "args": "chat (str); user (str)",
            "body": "user identifier",
            "returns": "Text result or an error message.",
            "example": "{\"tool\": \"moderation.unmute\", \"args\": {\"chat\": \"@chat\", \"user\": \"@user\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "moderation.ban": {
            "desc": "Ban a user from a chat",
            "args": "chat (str); user (str); reason (str) — optional",
            "body": "user identifier",
            "returns": "Text result or an error message.",
            "example": "{\"tool\": \"moderation.ban\", \"args\": {\"chat\": \"@chat\", \"user\": \"@user\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "moderation.unban": {
            "desc": "Unban a user from a chat",
            "args": "chat (str); user (str)",
            "body": "user identifier",
            "returns": "Text result or an error message.",
            "example": "{\"tool\": \"moderation.unban\", \"args\": {\"chat\": \"@chat\", \"user\": \"@user\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "moderation.kick": {
            "desc": "Kick a user from a chat (can rejoin)",
            "args": "chat (str); user (str); reason (str) — optional",
            "body": "user identifier",
            "returns": "Text result or an error message.",
            "example": "{\"tool\": \"moderation.kick\", \"args\": {\"chat\": \"@chat\", \"user\": \"@user\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "moderation.promote": {
            "desc": "Promote a user to admin",
            "args": "chat (str); user (str); rank (str) — admin title",
            "body": "user identifier",
            "returns": "Text result or an error message.",
            "example": "{\"tool\": \"moderation.promote\", \"args\": {\"chat\": \"@chat\", \"user\": \"@user\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "moderation.demote": {
            "desc": "Demote an admin back to member",
            "args": "chat (str); user (str)",
            "body": "user identifier",
            "returns": "Text result or an error message.",
            "example": "{\"tool\": \"moderation.demote\", \"args\": {\"chat\": \"@chat\", \"user\": \"@user\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "moderation.pin": {
            ...
            "example": "{\"tool\": \"moderation.pin\", \"args\": {\"chat\": \"@chat\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "moderation.delete_messages": {
            "desc": "Delete multiple messages in a chat",
            "args": "chat (str); ids (str) — comma-separated IDs",
            "body": "not used",
            "returns": "Confirmation text with the performed action details, or an error message.",
            "example": "{\"tool\": \"moderation.delete_messages\", \"args\": {\"chat\": \"@chat\", \"ids\": \"123,124\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "moderation.get_admins": {
            ...
            "example": "{\"tool\": \"moderation.get_admins\", \"args\": {\"chat\": \"@chat\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
    }
