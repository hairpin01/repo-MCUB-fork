...
class MessagePlugin:
    ...
    tool_docs = {
        "message.send_current": {
            "desc": "Send a message to the current chat",
            "args": "message (str) or text (str) — content",
            "body": "message text",
            "returns": "Confirmation text with the performed action details, or an error message.",
            "example": "{\"tool\": \"message.send_current\", \"args\": {\"text\": \"Hello\"}, \"body\": \"Hello\"}",
        ...
        "message.send_target": {
            ...
            "args": "chat (str) or to (str) — target; message (str) or text (str) — content",
            "body": "message text",
            "returns": "Confirmation text with the performed action details, or an error message.",
            "example": "{\"tool\": \"message.send_target\", \"args\": {\"chat\": \"@chat\", \"text\": \"Hello\"}, \"body\": \"Hello\"}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "message.edit": {
            "desc": "Edit a previously sent message",
            "args": "message (str) or msg (str) — message ID or link",
            "body": "new text",
            "returns": "Text result or an error message.",
            "example": "{\"tool\": \"message.edit\", \"args\": {\"message\": \"123\"}, \"body\": \"new text\"}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "message.delete": {
            "desc": "Delete one or more messages",
            "args": "ids (str) — comma-separated IDs",
            "body": "not used",
            "returns": "Confirmation text with the performed action details, or an error message.",
            "example": "{\"tool\": \"message.delete\", \"args\": {\"ids\": \"123,124\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "message.history": {
            "desc": "Get recent messages from a chat",
            "args": "chat (str) — optional; limit (int) — max messages (default 20)",
            "body": "not used",
            "returns": "Text result with the requested data, or an error message.",
            "example": "{\"tool\": \"message.history\", \"args\": {\"chat\": \"@chat\", \"limit\": 20}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "message.search": {
            "desc": "Search messages across chats",
            "args": "q (str) or query (str) — search text; chat (str) — optional scope",
            "body": "query text",
            "returns": "Text result with the requested data, or an error message.",
            "example": "{\"tool\": \"message.search\", \"args\": {\"chat\": \"@chat\", \"query\": \"hello\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "message.forward": {
            "desc": "Forward a message to another chat",
            "args": "from_chat (str); msg_id (int); to (str) — destination",
            "body": "not used",
            "returns": "Confirmation text with the performed action details, or an error message.",
            "example": "{\"tool\": \"message.forward\", \"args\": {\"chat\": \"@source\", \"message\": \"123\", \"to\": \"@target\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "message.pin": {
            "desc": "Pin a message in a chat",
            "args": "chat (str) — target; message (str) or msg (str) — message ID",
            "body": "not used",
            "returns": "Confirmation text with the performed action details, or an error message.",
            "example": "{\"tool\": \"message.pin\", \"args\": {\"chat\": \"@chat\", \"message\": \"123\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "message.reply": {
            "desc": "Reply to a message",
            "args": "chat (str); reply_to (int) — message ID; message (str) — content",
            "body": "reply text",
            "returns": "Text result or an error message.",
            "example": "{\"tool\": \"message.reply\", \"args\": {\"chat\": \"@chat\", \"message\": \"123\", \"text\": \"Hello\"}, \"body\": \"Hello\"}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "message.react": {
            "desc": "React to a message with an emoji",
            "args": "chat (str); message (str) or msg (str) — message ID; emoji (str) — reaction",
            "body": "not used",
            "returns": "Confirmation text with the performed action details, or an error message.",
            "example": "{\"tool\": \"message.react\", \"args\": {\"message\": \"123\", \"emoji\": \"👍\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "message.get": {
            "desc": "Get a specific message by ID",
            "args": "chat (str); message (str) or msg (str) — message ID",
            "body": "not used",
            "returns": "Text result with the requested data, or an error message.",
            "example": "{\"tool\": \"message.get\", \"args\": {\"chat\": \"@chat\", \"message\": \"123\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "message.mark_read": {
            "desc": "Mark messages as read in a chat",
            "args": "chat (str); max_id (int) — optional",
            "body": "not used",
            "returns": "Confirmation text with the performed action details, or an error message.",
            "example": "{\"tool\": \"message.mark_read\", \"args\": {\"chat\": \"@chat\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "message.typing": {
            "desc": "Show typing indicator in a chat",
            "args": "chat (str) — target chat",
            "body": "not used",
            "returns": "Text result with the requested data, or an error message.",
            "example": "{\"tool\": \"message.typing\", \"args\": {\"chat\": \"@chat\", \"seconds\": 5}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "message.schedule": {
            "desc": "Schedule a message for later",
            "args": "chat (str); message (str) — content; schedule (int) — unix timestamp",
            "body": "message text",
            "returns": "Text result or an error message.",
            "example": "{\"tool\": \"message.schedule\", \"args\": {\"chat\": \"@chat\", \"text\": \"Hello later\", \"when\": \"2026-01-01 12:00\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "message.draft": {
            "desc": "Save or update a draft message",
            "args": "chat (str); message (str) — draft text",
            "body": "draft text",
            "returns": "Text result or an error message.",
            "example": "{\"tool\": \"message.draft\", \"args\": {\"chat\": \"@chat\", \"text\": \"Draft\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
    }
