...
class ChatPlugin:
    ...
    tool_docs = {
        "chat.info": {
            "desc": "Get info about a Telegram chat/group/channel",
            "args": "chat (str) or query (str) — username, ID, or link",
            "body": "chat identifier",
            "returns": "Text result with the requested data, or an error message.",
            "example": "{\"tool\": \"chat.info\", \"args\": {\"chat\": \"@chat\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "chat.participants": {
            "desc": "List participants in a chat",
            "args": "chat (str); limit (int) — max results (default 30)",
            "body": "chat identifier",
            "returns": "Text result with the requested data, or an error message.",
            "example": "{\"tool\": \"chat.participants\", \"args\": {\"chat\": \"@chat\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "chat.admins": {
            "desc": "List admins of a chat",
            "args": "chat (str) — chat identifier",
            "body": "chat identifier",
            "returns": "Text result with the requested data, or an error message.",
            "example": "{\"tool\": \"chat.admins\", \"args\": {\"chat\": \"@chat\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "chat.permissions": {
            "desc": "Get permissions of a chat",
            "args": "chat (str) — chat identifier",
            "body": "chat identifier",
            "returns": "Text result with the requested data, or an error message.",
            "example": "{\"tool\": \"chat.permissions\", \"args\": {\"chat\": \"@chat\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "chat.common_with_user": {
            "desc": "Find common chats with a user",
            "args": "user (str) — target user",
            "body": "user identifier",
            "returns": "Text result with the requested data, or an error message.",
            "example": "{\"tool\": \"chat.common_with_user\", \"args\": {\"chat\": \"@chat\", \"user\": \"@user\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "chat.set_title": {
            "desc": "Change the title of a chat",
            "args": "chat (str) — target; title (str) — new title",
            "body": "title text",
            "returns": "Confirmation text with the performed action details, or an error message.",
            "example": "{\"tool\": \"chat.set_title\", \"args\": {\"chat\": \"@chat\", \"title\": \"New title\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "chat.set_about": {
            "desc": "Change the description/about of a chat",
            "args": "chat (str) — target; about (str) or description (str) — new text",
            "body": "about text",
            "returns": "Confirmation text with the performed action details, or an error message.",
            "example": "{\"tool\": \"chat.set_about\", \"args\": {\"chat\": \"@chat\", \"about\": \"New description\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "chat.set_username": {
            "desc": "Change the username of a chat/channel",
            "args": "chat (str) — target; username (str) — new username",
            "body": "not used",
            "returns": "Confirmation text with the performed action details, or an error message.",
            "example": "{\"tool\": \"chat.set_username\", \"args\": {\"chat\": \"@chat\", \"user\": \"@user\", \"username\": \"new_username\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "chat.slowmode": {
            "desc": "Set slowmode interval in seconds",
            "args": "chat (str) — target; seconds (int) — slowmode delay",
            "body": "not used",
            "returns": "Confirmation text with the performed action details, or an error message.",
            "example": "{\"tool\": \"chat.slowmode\", \"args\": {\"chat\": \"@chat\", \"seconds\": 30}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
        "chat.invite_link": {
            "desc": "Get or create an invite link for a chat",
            "args": "chat (str) — target chat",
            "body": "not used",
            "returns": "Text result with the requested data, or an error message.",
            "example": "{\"tool\": \"chat.invite_link\", \"args\": {\"chat\": \"@chat\"}}",
            "notes": "Requires the current Telegram account to have access and sufficient permissions.",
        },
    }
