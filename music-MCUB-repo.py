    ...
    async def shazam_cmd(event):
        try:
            if not event.is_reply:
                await event.edit(
                    "🔇 <b>reply to audio/video/voice message</b>", parse_mode="html"
                )
                return
            ...
            if not (reply.audio or reply.voice or reply.video):
                await event.edit(
                    "🎵 <b>message must contain audio/video</b>", parse_mode="html"
                )
                return
            ...
            try:
                ...
                if "track" in result:
                    ...
                    await event.edit(
                        "🎼 <b>music not recognized</b>", parse_mode="html"
                    )
            ...
            builder = event.builder.article(
                ...
                buttons=[
                    [
                        Button.url(
                            "Search on Shazam",
                            f"https://www.shazam.com/search?term={query}",
                        )
                    ],
